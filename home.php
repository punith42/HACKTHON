...
<body>
    ...
    <header>
        ...
        <a href="#" class="logo"><span>HACKTHON</span></a>
    ...
    <section class="home" id="home">
        ...
        <div class="content">
            <span> Incredible Karnataka: </span>
    ...
    <section class="review" id="review">
        ...
        <div class="box-container">
            ...
            <div class="box">
                ...
                <p>Booking my dream trip to the serene backwaters of Kerala was a breeze with HACKTHON – seamless and stress-free! </p>
                <div class="user">
            ...
            <div class="box">
                ...
                <p>Thanks to HACKTHON, I explored the majestic beauty of Rajasthan with ease, and the deals were unbeatable!</p>
                <div class="user">
    ...
    <section class="footer">
        ...
        <div class="box-container">
            ...
            <div class="box">
                <h3>contact info</h3>
                <a href="https://github.com/Ranju2004">GitHub</a>
                <img src="./images/payment.png" alt="">
            </div>
        </div>

        <div class="credit">&copy;2025 HACKTHON</div>
